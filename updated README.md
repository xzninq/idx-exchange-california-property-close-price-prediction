...
Week 9 (Streamlit prediction app) was intentionally skipped and can be
added back once the modeling above is finalized.
"""

with open(os.path.join(OUTPUT_DIR, "README.md"), "w") as fh:
    fh.write(readme)

print("\nDone. See the outputs/ folder for plots, CSV summaries, and README.md.")
